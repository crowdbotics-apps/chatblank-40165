"""
Django settings for chatblank_40165 project.
...
ROOT_URLCONF = 'chatblank_40165.urls'
...
WSGI_APPLICATION = 'chatblank_40165.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chatblank_40165 API",
    "DESCRIPTION": "API documentation for chatblank_40165 App",
    "VERSION": "v1",
}
